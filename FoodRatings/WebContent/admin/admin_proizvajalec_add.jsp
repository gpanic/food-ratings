...
<div id="body_container">
	...
	<div id="content">
		<form action="/FoodRatings/AddProizvajalecServlet" method="post">
			<div class="item_details">
				<h1>Dodaj proizvajalca</h1>
				<div>
					<p class="item_att">Naziv</p>
					<p class="item_att_textfield"><input type="text" class="input_text" name="naziv"/></p>
				</div>
				<div>
					<p class="item_att">Drzava</p>
					<p class="item_att_textfield"><input type="text" class="input_text" name="drzava"/></p>
				</div>
				<div>
					<p class="item_att">Mesto</p>
					<p class="item_att_textfield"><input type="text" class="input_text" name="mesto"/></p>
				</div>
			</div>
			<div class="buttons">
