...
public class ManageUporabnikExport1_ManageUporabnikHttpPortProxy{

    protected Descriptor _descriptor;

    public class Descriptor {
        private client.uporabnik.ManageUporabnikExport1ManageUporabnikHttpService _service = null;
        private client.uporabnik.ManageUporabnik _proxy = null;
        ...
        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new client.uporabnik.ManageUporabnikExport1ManageUporabnikHttpService(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            try
            {
                ...
                _service = (client.uporabnik.ManageUporabnikExport1ManageUporabnikHttpService)ctx.lookup("java:comp/env/service/ManageUporabnikExport1_ManageUporabnikHttpService");
            }
            ...
            if (_service == null && !_useJNDIOnly)
                _service = new client.uporabnik.ManageUporabnikExport1ManageUporabnikHttpService();
            initCommon();
        }
        ...
        public client.uporabnik.ManageUporabnik getProxy() {
            return _proxy;
        }
    ...
    public ManageUporabnikExport1_ManageUporabnikHttpPortProxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(true);
    }

    public ManageUporabnikExport1_ManageUporabnikHttpPortProxy(URL wsdlLocation, QName serviceName) {
